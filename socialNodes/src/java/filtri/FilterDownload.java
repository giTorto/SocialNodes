...
public class FilterDownload implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            file_group = manager.getGruppoOfPost(Integer.parseInt(fileId));
        } catch (NumberFormatException | SQLException e) {
            System.err.println("Filtro download: errore nel reperire gruppo relativo al fileid=" + fileId);
        }
        boolean ok_download = false;
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FilterDownload:Initializing filter");
            }
        }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("FilterDownload(");
