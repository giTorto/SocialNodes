...
public class FilterModeratore implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean ok_isModeratore = false;

        if (debug) {
            log("FilterModeratore:doFilter()");
        }
        ...
        if (session != null) {
            ...
            ok_isModeratore = false;
        }

        if (user.getIsModeratore() == 1) {
            ok_isModeratore = true;
        } else {
            ok_isModeratore = false;
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FilterModeratore:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilterModeratore()");
        }
        StringBuffer sb = new StringBuffer("FilterModeratore(");
