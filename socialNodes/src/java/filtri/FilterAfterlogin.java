 ...
 * @author Lorenzo
 */
public class FilterAfterlogin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        switch (operazione) {
            case "tomoderatore":
                //gestione dell'accesso al pannelli di controllo per moderatore
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FilterAfterlogin:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilterAfterlogin()");
        }
        StringBuffer sb = new StringBuffer("FilterAfterlogin(");
