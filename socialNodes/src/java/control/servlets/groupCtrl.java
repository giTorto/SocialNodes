...
public class groupCtrl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet groupCtrl</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet groupCtrl at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (operazione) {
            ...
            case "": // caso dell'aggiungi post (non si può settare l'operazione altrimenti non prende file)
                String fileName,relPath, path;
                String tmp = null;
                fileName = null;
